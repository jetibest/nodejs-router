...
class HttpProxyMiddleware {
    constructor(context, opts) {
        ...
        this.handleUpgrade = async (req, socket, head) => {
            if (!socket.handled && this.shouldProxy(this.config.context, req)) {
				socket.handled = true; // custom modification by me due to race condition bug, see: https://github.com/chimurai/http-proxy-middleware/issues/818
                const activeProxyOptions = await this.prepareProxyRequest(req);
